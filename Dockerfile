...
# sudo docker build --build-arg=READ_FROM_REGISTRY=<GITHUB_REGISTRY_TOKEN> -t auth-ses-mongo .
# sudo docker run -it --rm --name auth-ses-mongo-starter auth-ses-mongo
...
LABEL org.opencontainers.image.source=https://github.com/juliusagency/node-starter-with-auth-ses-mongo
